...
class Contact_us extends JFrame implements ActionListener{
    ...
    Contact_us(){
        ...
        JTextArea t1=new JTextArea("For any further information. Feel free to Contact us");
        t1.setEditable(false);
        t1.setPreferredSize(new Dimension(1000, 50));
        t1.setFont(new Font("Arial",Font.PLAIN,40));
        p1.add(t1);
        
        JTextArea t2=new JTextArea("SURYA HOSPITAL,S.N.Sah road\n" +
"S.N.Sah road, Katihar,\n" +
"854104, Bihar.\n" +
"Co:6204532586\n" +
"Mail:sanojkumar672@gmail.com");
        t2.setEditable(false);
        t2.setPreferredSize(new Dimension(1000, 150));
        t2.setFont(new Font("Arial",Font.PLAIN,25));
        p1.add(t2);
        
        JTextArea t3=new JTextArea("If you want to contact the developer of this site.\n" +
"So, Kindly contact:");
        t3.setEditable(false);
        t3.setPreferredSize(new Dimension(1000, 50));
        t3.setFont(new Font("Arial",Font.PLAIN,40));
        p1.add(t3);
      
        JTextArea t4=new JTextArea("SANOJ KUMAR\n" +
"Co:8409839676\n" +
"Mail:sanojkumar9431@gmail.com");
        t4.setEditable(false);
        t4.setPreferredSize(new Dimension(1000, 125));
        t4.setFont(new Font("Arial",Font.PLAIN,25));
        p1.add(t4);
