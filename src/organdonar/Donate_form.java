...
public class Donate_form extends JFrame implements ActionListener {
    ...
    public Donate_form() {
        ...
        JPanel p=new JPanel();
        p.setLayout(new GridLayout(14,1,10,10));
        
        p.setBackground(Color.WHITE);
        
        l1=new JLabel("Donar Name");
        t1=new JTextField();
        p.add(l1);
        p.add(t1);
        ...
        l5=new JLabel("Have you any disease? if yes, please mention here");
        t5=new JTextField();
        p.add(l5);
        p.add(t5);
        
        l2=new JLabel("Date of Donate");
        t2=new JTextField();
        p.add(l2);
        p.add(t2);
        
        l3=new JLabel("Are you willing to donate ? (yes/no)");
        t3=new JTextField();
        p.add(l3);
        p.add(t3);
        ...
        String q2="insert into donate_form values('"+a+"','"+k+"','"+f+"','"+c+"','"+d+"','"+ee+"')";
